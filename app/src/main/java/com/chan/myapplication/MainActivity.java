...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        planets.add(new Planet("Mercury", "mercury.png","4,880 KM","STILL PART OF SOLAR SYSTEM"));
        planets.add(new Planet("Venus", "venus.jpg","12,104 KM","STILL PART OF SOLAR SYSTEM"));
        planets.add(new Planet("Earth", "earth.jpg","12,742 KM","STILL PART OF SOLAR SYSTEM"));
        ...
        planets.add(new Planet("Pluto", "pluto.jpg","2,377 KM","NOT PART OF SOLAR SYSTEM"));
